...
namespace TaskManager.Services.Implementations
{
    public class GenerateEmailPage : IGenerateEmailPage
    {
                ...
                <body>
                  <div class=""container"">
                     <h1>Email Verification</h1>
                        <p>Hi {name},Thanks for getting started with our Task Manager App!</p>
        ...
        public string TaskNotificationPage(string message, string callbackUrl, NotificationType notificationType)
        {
            string html = $@"
                <!DOCTYPE html>
                <html>
